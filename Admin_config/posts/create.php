        ...
        <div class="all-content-wrapper">
            <div class="postForm">
                ...
                <h2 style="animation: fadeInUp 0.8s ease-in 0ms forwards; visibility:hidden;">Add new post</h2>
                <div>

                <div class="media">
                    <input style="display: none;" type="file" name="coverImage" id="coverImage">
                    <button style="animation: fadeInUp 0.8s ease-in 0ms forwards; visibility:hidden;" onclick="addMedia()" class="magicbutton2">
                ...
                <div>
                    <textarea name="content" id="content" class="magicbox" name="content" style="animation: fadeInUp-bigDivs 0.8s ease-in 0.2ms forwards; visibility:hidden;"> </textarea>
                </div>
             
            </div>
            </form>
    <aside>
        <div class="publish " style="animation: fadeInUp 0.8s ease-in 100ms forwards; visibility:hidden;">
        ...
        <div class="category" style="animation: fadeInUp 0.8s ease-in 100ms forwards; visibility:hidden;">
            ...
            <div class="cat-option">
                ...
                <div class="cat-list">
                    <div>
                        <input type="checkbox" onclick="uncategorized(this)" name="uncategorized" id="uncat">
                ...
                <div class="most-used-cat">
                    <div>
                        <input type="radio" name="" id="cat" disabled>
